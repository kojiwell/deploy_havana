...
echo deb http://ubuntu-cloud.archive.canonical.com/ubuntu precise-updates/havana main > /etc/apt/sources.list.d/havana_updates
...
GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'localhost' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'$CONTROLLER_ADMIN_ADDRESS' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'$MYSQL_ALLOWED_SUBNET' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
CREATE DATABASE cinder;
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'localhost' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'$CONTROLLER_ADMIN_ADDRESS' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'$MYSQL_ALLOWED_SUBNET' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
CREATE DATABASE glance;
GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'localhost' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'$CONTROLLER_ADMIN_ADDRESS' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'$MYSQL_ALLOWED_SUBNET' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
CREATE DATABASE keystone;
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'localhost' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'$CONTROLLER_ADMIN_ADDRESS' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'$MYSQL_ALLOWED_SUBNET' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
CREATE DATABASE neutron;
GRANT ALL PRIVILEGES ON neutron.* TO 'neutron'@'localhost' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON neutron.* TO 'neutron'@'$CONTROLLER_ADMIN_ADDRESS' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
GRANT ALL PRIVILEGES ON neutron.* TO 'neutron'@'$MYSQL_ALLOWED_SUBNET' IDENTIFIED BY '$MYSQL_DB_PASSWORD';
FLUSH PRIVILEGES;
EOF
}
...
neutron_url=http://$CONTROLLER_INTERNAL_ADDRESS:9696
neutron_auth_strategy=keystone
neutron_admin_tenant_name=service
neutron_admin_username=neutron
neutron_admin_password=$KEYSTONE_ADMIN_PASSWORD
neutron_admin_auth_url=http://$CONTROLLER_INTERNAL_ADDRESS:35357/v2.0
